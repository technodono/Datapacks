...
execute as @s at @s if entity @e[distance=..0.5,type=!#shelve:entity_mask,tag=!tcss.eldritch_shelf] if block ~ ~ ~ minecraft:air run function shelve:block/eldritch_shelf/abort_summon
execute as @s at @s unless block ~ ~ ~ minecraft:air run function shelve:block/eldritch_shelf/abort_summon
execute as @s at @s if block ~ ~ ~ minecraft:air unless entity @e[distance=..0.5,type=!#shelve:entity_mask,tag=!tcss.eldritch_shelf] run function shelve:block/eldritch_shelf/complete
